...
# Model / training
# ============================================================
# Available Models (just change MODEL_NAME, nothing else needed)
# ============================================================
# EfficientNet family:
...
#   "convnext_xlarge", "convnextv2_tiny", "convnextv2_small", "convnextv2_base",
...
#
# MobileNet family:
#   "mobilenetv3_small_100", "mobilenetv3_large_100", "mobilenetv3_rw",
#   "mobilenetv2_100", "mobilenetv2_140", "mobilenetv2_120d"
#
# Vision Transformer (ViT) family:
#   "vit_tiny_patch16_224", "vit_small_patch16_224", "vit_base_patch16_224",
#   "vit_large_patch16_224", "vit_base_patch32_224", "vit_large_patch32_224"
#
...
#   "regnetx_160", "regnetx_320", "regnety_002", "regnety_004", etc.
#
# To see ALL available models, run: timm.list_models()
# ============================================================

MODEL_NAME = "mobilenetv3_large_100"   # Change this to any timm model name above
...
# Uncomment to explore available models:
# list_available_models()  # Show all
# list_available_models("efficientnet")  # Show EfficientNet variants
# list_available_models("convnext")  # Show ConvNeXt variants
